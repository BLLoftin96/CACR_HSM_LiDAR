...
Commands: - Rotate with left mouse button - Zoom with mouse wheel - Pan with right mouse button - Keyboard r or g or b to color with RGB - Keyboard z to color with Z - Keyboard i to color with Intensity - Keyboard c to color with Classification - Keyboard + or - to change the point size - Keyboard l to enable/disable eyes-dome lightning
...
We will also be trying the PMF (progressive morphological filter) which creates a small window and fins the low points where it then gradually increases the window size and allow higher thresholds as terrain scale increases.
